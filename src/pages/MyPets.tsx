      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-500 text-sm mt-0.5">
            {pets.length} pet{pets.length !== 1 ? "s" : ""} in your
            collection
          </p>
        </div>
        ...
        <button
          onClick={() => {
            ...
            supabase
              ...
              .order("created_at", { ascending: false })
              .then(({ data, error }) => {
                console.log("REFRESH PETS DATA:", data);
                console.log("REFRESH PETS ERROR:", error);
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="mt-1.5 flex flex-wrap gap-1.5">
                    ...
                    {pet.is_clone && (
                      <span className="px-2 py-0.5 text-[10px] rounded-full bg-violet-100 border border-violet-300 text-violet-700 uppercase font-semibold">
                        Clone
                      </span>
                    )}
                  </div>
...
function PetDetailModal({
  ...
  return (
    ...
    >
      <div
        className="bg-white border border-slate-200 rounded-2xl shadow-2xl w-full max-w-lg max-h-[85vh] overflow-y-auto"
        onClick={(e) => e.stopPropagation()}
      >
        <div
          className={`relative ${c.bg} p-6 border-b ${c.border}`}
        >
          <button
            onClick={onClose}
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <div className="mt-2 flex flex-wrap gap-2">
                ...
                {pet.is_clone && (
                  <span className="px-2.5 py-1 text-xs rounded-full bg-violet-100 border border-violet-300 text-violet-700 uppercase font-semibold">
                    Clone
                  </span>
                )}
              </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <StatBox
                ...
                label="Crit Chance"
                value={`${(pet.crit_chance * 100).toFixed(1)}%`}
              />
