    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between flex-wrap gap-3">
        ...
        <div className="flex gap-2">
          ...
          <button
            onClick={() => { setSellPet(null); setSellPrice(""); setSellModalOpen(true); }}
      ...
      <SellModal
        ...
        onClose={() => { setSellPet(null); setSellModalOpen(false); }}
        busy={busy}
        error={error}
        open={sellModalOpen}
      />
...
function SellModal({ pets, selectedPet, onSelect, price, onPriceChange, onConfirm, onClose, busy, error, open }:
  { pets: Pet[]; selectedPet: Pet | null; onSelect: (p: Pet) => void; price: string; onPriceChange: (v: string) => void; onConfirm: () => void; onClose: () => void; busy: boolean; error: string | null; open: boolean; }) {
          ...
          <div>
            ...
            <div className="max-h-48 overflow-y-auto space-y-2">
              {eligible.map((p) => (
                ...
                >
                  <PetAvatar tier={p.tier} species={p.species} spriteSeed={p.sprite_seed} size={40} />
                  <div className="flex-1 min-w-0">
      ...
      {listing && (
        <div className="space-y-4">
          <div className="flex items-center gap-3 p-3 bg-slate-50 rounded-lg border border-slate-200">
            <PetAvatar tier={listing.pet!.tier} species={listing.pet!.species} spriteSeed={listing.pet!.sprite_seed} size={56} />
            <div>
